...
var React = require('react'),
    ...
    InitModal = React.createClass({
        ...
        render(){
            return (
                <div>
                    <Modal show={this.state.showInitModal} onHide={this.closeInitModal}
                           dialogClassName='error-modal-dialog' enforceFocus={true}>
                        <Modal.Header>
                            <Modal.Title id='contained-modal-title-sm'><i
                                className='ion-upload'></i> Hello!</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <p>
                                Welcome to TREZOR Password Manager! It looks like you don't have any passwords saved yet. Would you like to setup your new password database?
                            </p>
                        </Modal.Body>
                        <div className='btn-controls'>
                            <Button className='button shadow white-btn' onClick={this.retryStorage}>I'm not new, try again</Button>
                            <Button className='button shadow blue-btn' onClick={this.initNewStorage}>Yes, start now!</Button>
                        </div>
                    </Modal>
                </div>
            )
